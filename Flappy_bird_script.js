...
const pipe = {
    ...
    draw : function(){
        for(let i  = 0; i < this.position.length; i++){
            ...
            ctx.drawImage(sprite, this.top.sX, this.top.sY, this.w, this.h, p.x, topYPosition, this.w, this.h);


            ctx.drawImage(sprite, this.bottom.sX, this.bottom.sY, this.w, this.h, p.x, bottomYPosition, this.w, this.h);
        }
    },
